...
//   // if ball hits top of canvas (ball.x - ball.radius < 0)
//   // ball did not hit any bricks (brickCollision == false) || score != incremented;
//   // ball hits paddle (paddleCollision == true);
